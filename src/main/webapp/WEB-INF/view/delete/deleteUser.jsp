                    ...
                    <div class="container" style="margin-top: 85px">
                        <div class="row clearfix">
                            ...
                            <div class="form-group">
                                <label for="username">请确认删除的用户</label><input  type="text" name="username" class="form-control" id="username" />
                                <label for="password">请确认删除用户名的密码</label><input  type="password" name="password" class="form-control" id="password" />
                            </div>
