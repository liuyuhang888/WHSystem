...
<div class="warp clearfix">
    <div class="left">
        ...
        <ul class="left_content">
            ...
            <li>
                <a href="/product/inputList" class="html1 active">
    ...
    <div class="right">
        ...
        <div class="right_content">
            ...
            <div src="html1.html" name="content" class="iframe">
                <%--内容页开始--%>
                <form action="/productCategory/changeCategory" method="post" >
                <div class="container" style="margin-top: 85px">
                    <div class="row clearfix">
                        <input type="hidden" value="${category.productCategoryId}" name="productCategoryId">
                        <div class="form-group">
                            <label for="productCategoryName">产品分类名称</label><input value="${category.productCategoryName}" type="text" name="productCategoryName" class="form-control" id="productCategoryName" />
                        </div>
