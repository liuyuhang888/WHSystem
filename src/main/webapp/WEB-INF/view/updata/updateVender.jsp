    ...
    <div class="right">
        ...
        <div class="right_content">
            ...
            <div src="html1.html" name="content" class="iframe">
                <%--内容页开始--%>
                <form action="/vender/changeVender" method="post">
                <div class="container" style="margin-top: 85px">
                    <div class="row clearfix">
                        <input type="hidden" value="${vender.venderId}" name="venderId">
                        <div class="form-group">
                            <label for="venderName">经销商名称</label><input type="text" value="${vender.venderName}" name="venderName" class="form-control" id="venderName" />
                        </div>
                        <div class="form-group">
                            <label for="venderDesc">经销商描述</label><input type="text" value="${vender.venderDesc}" name="venderDesc" class="form-control" id="venderDesc" />
                        </div>
